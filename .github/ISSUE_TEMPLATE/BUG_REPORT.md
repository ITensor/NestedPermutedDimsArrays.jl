---
name: NestedPermutedDimsArrays.jl bug report
about: Create a bug report to help us improve NestedPermutedDimsArrays.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("NestedPermutedDimsArrays")`:
```julia
julia> using Pkg; Pkg.status("NestedPermutedDimsArrays")
[YOUR OUTPUT HERE]
```
